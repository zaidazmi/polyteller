...
/* harmony import */ var _utils_logUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/logUtils */ "./src/utils/logUtils.ts");
/**
...
function displayCountdown(eventInfo) {
    ...
    if (!countdownElement || !localEndTimeElement || !notificationSection) {
        (0,_utils_logUtils__WEBPACK_IMPORTED_MODULE_4__.log)('Countdown', 'Required elements not found');
        return;
    }
...
/* harmony import */ var _manifest_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../manifest.json */ "./manifest.json");
...
function createDonateWidget() {
  ...
  `;
    ...
    <div class="footer-copyright">
      © ${new Date().getFullYear()} Polyteller v${_manifest_json__WEBPACK_IMPORTED_MODULE_1__.version}. All rights reserved.
    </div>
  `;
    ...
    if (emailLink) {
        emailLink.addEventListener('click', async (e) => {
            ...
            try {
                ...
                (0,_utils__WEBPACK_IMPORTED_MODULE_2__.displayStatus)('Email copied to clipboard!', true);
            }
            catch (err) {
                (0,_utils__WEBPACK_IMPORTED_MODULE_2__.displayStatus)('Failed to copy email', false);
            }
        });
    }
    // Add styles
...
/* harmony import */ var _types_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../types/messages */ "./src/types/messages.ts");
...
async function initPrivacyModeToggle() {
    ...
    toggle.addEventListener('change', async () => {
        ...
        // Notify all tabs
        chrome.runtime.sendMessage({
            type: _types_messages__WEBPACK_IMPORTED_MODULE_2__.MessageType.BROADCAST_PRIVACY_MODE,
    ...
    try {
        ...
        chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
            ...
            if (message.type === 'EVENT_INITIALIZED') {
                (0,_utils_logUtils__WEBPACK_IMPORTED_MODULE_1__.log)('Popup', 'Received EVENT_INITIALIZED message:', message.data);
                _store_store__WEBPACK_IMPORTED_MODULE_5__.useStore.getState().addEvent(message.data);
                (0,_components_uiUpdates__WEBPACK_IMPORTED_MODULE_2__.updateUI)(message.data);
                loadNotifications();
            }
        });
...
module.exports = /*#__PURE__*/JSON.parse('{"manifest_version":3,"name":"Polyteller: Upgrade your Polymarket trading","version":"1.0.5","version_name":"1.0.5","minimum_chrome_version":"110","description":"Real-time countdowns, customizable notifications, and privacy features for Polymarket traders.","author":"hi@polyteller.com","permissions":["storage","alarms","notifications","tabs"],"host_permissions":["https://*.polymarket.com/*"],"background":{"service_worker":"background.js"},"content_scripts":[{"matches":["https://*.polymarket.com/*"],"js":["privacyModeEarly.js"],"run_at":"document_start","all_frames":true},{"matches":["https://*.polymarket.com/*"],"js":["content.js","privacyMode.js"],"css":["content.css"]}],"action":{"default_popup":"popup.html","default_icon":{"16":"icon16.png","32":"icon32.png","48":"icon48.png","128":"icon128.png"}},"icons":{"16":"icon16.png","32":"icon32.png","48":"icon48.png","128":"icon128.png"},"web_accessible_resources":[{"resources":["styles.css","allNotifications.html","https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;600;700&display=swap"],"matches":["https://*.polymarket.com/*"]}],"content_security_policy":{"extension_pages":"script-src \'self\'; object-src \'self\'; style-src \'self\' https://fonts.googleapis.com \'unsafe-inline\';"},"privacy":{"message":"This extension only reads event times and titles to provide countdowns and notifications. It does not collect, store, or transmit any personal data, wallet information, or trading data. All data is stored locally on your device and is never sent to external servers."},"data_usage":{"collection":false,"transmission":false,"personalization":false,"authentication":false},"homepage_url":"https://polyteller.com","offline_enabled":true,"short_name":"Polyteller"}');
